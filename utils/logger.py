...
class Log_loss:
    ...
    def append_loss(self, loss, val_loss):
        ...
        self.loss_plot()
    def append_acc(self,acc_train,acc_test):
    ...
    def acc_plot(self):
        ...
        plt.figure()
        plt.plot(iters, self.acc_train, 'red', linewidth=2, label='train acc')
        plt.plot(iters, self.acc_test, 'coral', linewidth=2, label='val acc')
        ...
        plt.savefig(os.path.join(self.log_dir, "acc_" + str(self.time_str) + ".png"))
